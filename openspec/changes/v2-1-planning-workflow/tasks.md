...
- [ ] 1.3 The delivery tasks of this change's `tasks.md` (sections 0 and 4, written by hand in #105) are the template's output; the rule reproduces them
- [ ] 1.4 Migrate this change to the forked schema: write its `architect-review.md` (self-review against principles §I–VII, unmapped scenarios as findings) so `openspec status` shows no missing artifact
