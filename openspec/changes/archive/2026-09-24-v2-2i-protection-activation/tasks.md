...
- [x] 5.1 With a clean worktree run `python skills/agent-process/scripts/archive_change.py v2-2i-protection-activation`; verify that it applies the `distribution` delta, commits the archive, and pushes the branch
