...
| distribution | New release | `tests/publisher/test_plugin.py::test_version_drift`, `tests/publisher/test_init.py::test_update_dry_run_previews_the_selected_release`, `tests/publisher/test_init.py::test_update_hands_off_to_the_selected_release` |
