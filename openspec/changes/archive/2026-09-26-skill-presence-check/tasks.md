...
- [x] 4.1 With a clean worktree, run `python skills/agent-process/scripts/archive_change.py skill-presence-check`. Verify that it applies the `distribution` delta, commits the archive, and pushes the branch
