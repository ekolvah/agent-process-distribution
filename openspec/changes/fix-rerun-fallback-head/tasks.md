...
- [ ] 5.1 `git status --short` empty for this change's files → `python .agent-process/scripts/archive_change.py fix-rerun-fallback-head` (marks its own task, archives, commits, pushes)
