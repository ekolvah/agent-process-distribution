...
- [ ] 4.1 With a clean worktree, run `python skills/agent-process/scripts/archive_change.py test-import-guard`. Verify that it applies the `implementation` delta, commits the archive, and pushes the branch
