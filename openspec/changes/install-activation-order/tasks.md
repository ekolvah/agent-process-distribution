...
- [ ] 4.1 With a clean worktree, run `python skills/agent-process/scripts/archive_change.py install-activation-order`. Verify that it commits the archive (no spec delta: `skip_specs`) and pushes the branch
