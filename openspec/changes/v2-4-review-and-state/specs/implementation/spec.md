...
human step other than a thread the implementing run explicitly left to the person: reviews
start on PR open, the run applies the findings, the person is asked only to merge. Cycle
time SHALL be measured per PR.
