...
- [ ] 4.2 Run `python .agent-process/scripts/ci_check.py` and verify it passes; confirm `git diff --name-only origin/main` lists only the paths of the proposal's Impact and no workflow, ruleset, or Project file of this repository
