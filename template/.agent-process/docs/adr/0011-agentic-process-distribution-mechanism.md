...
(`.agent-process/docs/architecture/agent-process.md`, `principles.md`,
`.agents/orchestration/roles.yaml`, `change-classes.yaml`, the gate scripts
under `.agent-process/scripts/`), a Claude adapter (`.claude/commands`, `.claude/agents`,
...
* **Layer 0 (provider-neutral core)** and **Layer 2 (Codex `SKILL.md`
  ...
  repository's own audit (`.agent-process/docs/architecture/agent-process-export.md`) marks
...
This record and `.agent-process/docs/architecture/agent-process-export.md` are the
