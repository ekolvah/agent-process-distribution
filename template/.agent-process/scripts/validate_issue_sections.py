...
Usage: python .agent-process/scripts/validate_issue_sections.py <issue-number> [--mark-planned]
...
REQUIRED_SECTIONS: tuple[str, ...] = (
    ...
    # `.agent-process/docs/architecture/principles.md`.
    "Architect review",
...
def _parse_argv(raw: list[str]) -> tuple[int, bool, bool, str | None]:
    ...
    if len(positional) != 1:
        print(
            f"Usage: python .agent-process/scripts/validate_issue_sections.py <issue-number> "
