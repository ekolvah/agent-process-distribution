...
Reclassified publisher-only (issue #64): the three scripts under test
(`check_orphan_scope.py`, `open_pr.py`, `update_pr_body.py`) are byte-static across template renders, so this suite
...
from scripts import check_orphan_scope, open_pr, update_pr_body
