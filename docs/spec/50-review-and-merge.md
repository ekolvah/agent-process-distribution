...
- **REVW-2** (MUST) The reviewer reads the **diff** of the PR, not whole files, together
  with the issue's acceptance criteria and test plan (PLAN-8), and reports a criterion
  the diff leaves untested. The PR body lists tracked deferrals as issue links so a
  reviewer does not re-report them.
