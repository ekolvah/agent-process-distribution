...
one of the exact supported observed clean-marker first lines, one
`**Reviewed commit:**` label followed by one SHA-bound 10-hex value in
backticks, eligible owner request, and
