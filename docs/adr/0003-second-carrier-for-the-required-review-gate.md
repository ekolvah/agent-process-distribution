...
* Superseded by ADR 0015 on carrier ordering: Codex Automatic reviews now runs
  first, and Claude is availability fallback only when Codex evidence is absent
  or invalid.
