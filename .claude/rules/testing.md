...
[`principles.md §I`](../../skills/agent-process/principles.md) (Test-First) and
[`§II`](../../skills/agent-process/principles.md) (Protocol Boundaries + DI).
...
1. **RED first** — write the failing test from the issue `## Test plan` before
   ...
   [`principles.md §I`](../../skills/agent-process/principles.md)).
...
2. **No mocks of internal logic** —
   [`principles.md §II`](../../skills/agent-process/principles.md) applies.
